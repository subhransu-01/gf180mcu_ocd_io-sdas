...
N 1730 -410 1770 -410 {lab=OUT}
N 1730 -320 1730 -290 {lab=GND}
N 1620 -410 1660 -410 {lab=OUT}
...
C {lab_wire.sym} 1290 -350 0 0 {name=p5 sig_type=std_logic lab=IN}
...
tran 0.1n CACE\{Tmax\}
set wr_singlescale
wrdata CACE\{simpath\}/CACE\{filename\}_CACE\{N\}.data V(OUT) V(IN)
.endc
"}
