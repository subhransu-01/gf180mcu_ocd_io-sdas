...
meas tran tr TRIG v(Vout) VAL='0.1*CACE\{vdd\}' RISE=1 
meas tran tr TARG v(Vout) VAL='0.9*CACE\{vdd\}' RISE=1
meas tran tf TRIG v(Vout) VAL='0.9*CACE\{vdd\}' FALL=1 
meas tran tf TARG v(Vout) VAL='0.1*CACE\{vdd\}' FALL=1
