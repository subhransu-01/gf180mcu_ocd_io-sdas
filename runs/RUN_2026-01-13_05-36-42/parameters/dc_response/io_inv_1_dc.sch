...
C {lab_wire.sym} 1450 -410 0 0 {name=p3 sig_type=std_logic lab=IN}
...
C {lab_wire.sym} 1280 -350 0 0 {name=p5 sig_type=std_logic lab=IN}
...
.endc
"}
C {lab_wire.sym} 1760 -410 0 0 {name=p7 sig_type=std_logic lab=OUT}
