...
.MEASURE TRAN tr1090 TRIG v(Vout) VAL='0.1*CACE\{vdd\}' RISE=1 TARG v(Vout) VAL='0.9*CACE\{vdd\}' RISE=1
.MEASURE TRAN tf9010 TRIG v(Vout) VAL='0.9*CACE\{vdd\}' FALL=1 TARG v(Vout) VAL='0.1*CACE\{vdd\}' FALL=1

** Delay Rise Fall
.MEASURE TRAN tdrise TRIG v(vin)  VAL='0.5*CACE\{vdd\}' RISE=1 TARG v(vout) VAL='0.5*CACE\{vdd\}' RISE=1
.MEASURE TRAN tdfall TRIG v(vin)  VAL='0.5*CACE\{vdd\}' FALL=1 TARG v(vout) VAL='0.5*CACE\{vdd\}' FALL=1
