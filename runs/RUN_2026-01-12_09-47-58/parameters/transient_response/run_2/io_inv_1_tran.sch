...
C {vsource.sym} 1250 -290 0 0 {name=V3 value="0 PULSE(0 1.8 0 1n 1n 10n 20n)" savecurrent=false}
...
.endc
"}
C {lab_wire.sym} 1700 -410 0 0 {name=p7 sig_type=std_logic lab=Vout}
