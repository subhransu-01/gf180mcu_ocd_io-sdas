...
N -700 0 -130 -0 {lab=#net1}
N -130 -30 -130 -0 {lab=#net1}
N -140 -30 -130 -30 {lab=#net1}
N -610 -120 -610 70 {lab=#net2}
N -610 -120 -100 -120 {lab=#net2}
N -100 -120 -100 -80 {lab=#net2}
N -100 -80 -100 -70 {lab=#net2}
N -140 -70 -100 -70 {lab=#net2}
N -350 150 -350 210 {lab=GND}
N -350 30 -350 90 {lab=#net3}
N -440 30 -350 30 {lab=#net3}
N -440 -70 -440 30 {lab=#net3}
...
C {lab_wire.sym} -440 -40 0 0 {name=p2 sig_type=std_logic lab=Vin}
